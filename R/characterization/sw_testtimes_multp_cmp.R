...
if (length(args)==0) {
 ...
 #   filename <- "Autorange_TestTimes_SHORT_summary_all.csv"
    filename <- "Autorange_TestTimes_LONG_summary_all.csv"
} else {
...
#            pp      <- ggplot(data_rngType, aes(y=tt_mean)) + geom_bar(aes(x=range_cnt, fill=sw_version),
            pp      <- ggplot(data_rngType, aes(y=tt_mean)) + geom_bar(aes(x=range_cnt, fill=software),                                                    
                                                width=0.5,
                                                position="dodge",
                                                stat="identity")
